...
import roboLabUsage from './evidence/robolab-token-usage.json';
...
// Use the reported aggregate, rather than summing independently rounded task rows.
export const roboLabMeanTokens=Object.fromEntries(Object.entries(roboLabUsage.methods)
 .map(([method,row])=>[method,row.total_m*1e6/row.trajectories]));
...
export {roboDojoUsage,roboLabUsage};
